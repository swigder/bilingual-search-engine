...
def bilingual(test):
    def inner(collections, parsed_args):
        ...
        doc_dict = dictionary(parsed_args.doc_embed, use_subword=parsed_args.subword, language='doc')
        query_dict = dictionary(parsed_args.query_embed, use_subword=parsed_args.subword, language='query')
